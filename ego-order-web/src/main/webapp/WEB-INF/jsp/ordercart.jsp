...
<form id="orderForm" class="hide" action="/order/save" method="post">
		...
		value="<fmt:formatNumber groupingUsed="false" maxFractionDigits="2" 
		minFractionDigits="2" value="${totalPrice/100 }"/>"/>
		<input type="hidden" name="receiverName" value="绿野蓝杉"/>
		<input type="hidden" name="receiverMobile" value="15891588888"/>
		<input type="hidden" name="receiverState" value="福州"/>
		<input type="hidden" name="receiverCity" value="福建"/>
		<input type="hidden" name="receiverDistrict" value="鼓楼区"/>
		<input type="hidden" name="receiverAddress" value="西洪路 xxxxxxxxx"/>
		<input type="hidden" name="receiverZip" value="350001"/>
		...
		<div class="goods-item goods-item-extra">
			...
			<div class="goods-msg">
				...
				<div class="p-price">
					...
					<!--增加预售金额显示 end-->
					<span class="ml20"> ${cart.value.num} </span> 
		...
		<div class="order-summary">
			...
			<div class="statistic fr">
				<div class="list">
					...
					<em class="price" id="warePriceId">¥<fmt:formatNumber 
				...
				<div class="list">
					<span>应付总额：</span> <em class="price" id="sumPayPriceId">
						...
						maxFractionDigits="2" minFractionDigits="2" groupingUsed="true"/></em>
				</div>
			</div>
			<div class="clr"></div>
		</div>
